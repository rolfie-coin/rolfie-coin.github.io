...
const addTokens = document.getElementById('addTokens')
...
const initialize = async () => {
  ...
  const initializeAccountButtons = () => {
    ...
    addTokens.onclick = async() => {
      const tokenAddress = contractAddress;
      const tokenSymbol = 'ROLFIE';
      const tokenDecimals = 2;
      const tokenImage = currentUrl + '/rcoin.ico';

      console.info(tokenImage)
